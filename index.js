...
const Heracles = new Hero("👨 Heracles", 20, 6, "./images/heracles.svg", 9, 5);

/** Creating his weapon and associating it */
const weapon = new Weapon("sword", 10, "./images/sword.svg", 1);
const weapon2 = new Weapon("bow", 8, "./images/bow.svg", 5);
Heracles.weapon = weapon;
Heracles.weapon = weapon2;
...
const bird1 = new Monster("Bird", 25, 12, "./images/bird.svg", 4, 4, 1);
const bird2 = new Monster("Bird", 25, 12, "./images/bird.svg", 6, 8, 1);
const bird3 = new Monster("Bird", 25, 12, "./images/bird.svg", 1, 7, 1);
